				...
				success:function(data){
					if(data.info=="success"){
						$.layer({
							...
							area: ['650px', '522px'],
							iframe: {src: APP+'/Index/renewPay?cpu=' + data.data.CPU + '&ram=' + data.data.RAM + '&sys=' + data.data.OS + '&disk=' + data.data.DISK + '&iplc=' + data.data.BandWidthIPLC + '&bgp=' + data.data.BandWidthBGP + '&count=' + data.data.Count + '&oid=' + oid}
						});
					}
				},
				error:function(data){					

				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($vo["StockHouseName"]); ?></td>
								<td><?php echo ($vo["Data"]); ?></td>
								<td><?php echo ($vo["State"]); ?></td>
								<td><?php echo ($vo["PublicVlanBegin"]); ?> ~ <?php echo ($vo["PublicVlanEnd"]); ?></td>
								<td><?php echo ($vo["PrivateVlanBegin"]); ?> ~ <?php echo ($vo["PrivateVlanEnd"]); ?></td>
								<td><?php echo ($vo["PrivateIPBegin"]); ?> ~ <?php echo ($vo["PrivateIPEnd"]); ?></td>
								<td><?php echo ($vo["Mask"]); ?></td>
								<td>

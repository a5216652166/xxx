		...
		<form action="__URL__/edit" method="post">
			...
			<table class="table" cellspacing="0" cellpadding="0" width="100%" >
			    ...
			    <tr>
			      ...
			      <td class="ui_text_lt">
			      	<input type="text" name="TemplateCode" class="ui_input_txt03" value="<?php echo ($data["TemplateCode"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td class="ui_text_lt">
			      	<input type="text" name="SystemName" class="ui_input_txt03" value="<?php echo ($data["SystemName"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			      <td width="100px">描述：</td>
			      <td class="ui_text_lt">
			      	<textarea name="About" style="width:90%;height:400px;"><?php echo ($data["About"]); ?></textarea>
			      </td>
			    </tr>
			    <tr>

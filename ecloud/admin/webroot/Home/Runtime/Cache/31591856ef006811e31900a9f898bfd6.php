...
<script type="text/javascript">
	$(function() {
		...
		$("select[name=TemplateCode]").val('<?php echo ($data["TemplateCode"]); ?>').trigger('chosen:updated');
	});
		...
		<form action="__URL__/edit" method="post">
			...
			<table class="table" cellspacing="0" cellpadding="0" width="100%" >
			    ...
			    <tr>
			      ...
			      <td class="ui_text_lt">
			      	<input type="text" name="VMCode" class="ui_input_txt03" value="<?php echo ($data["VMCode"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			      <td width="100px">CPU：</td>
			      <td class="ui_text_lt">
			      	<input type="text" name="Cpu" class="ui_input_txt03" value="<?php echo ($data["Cpu"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			      <td width="100px">内存：</td>
			      <td class="ui_text_lt">
			      	<input type="text" name="Ram" class="ui_input_txt03" value="<?php echo ($data["Ram"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			      <td width="100px">硬盘：</td>
			      <td class="ui_text_lt">
			      	<input type="text" name="Disk" class="ui_input_txt03" value="<?php echo ($data["Disk"]); ?>" />
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td class="ui_text_lt">
			      	<input type="text" name="PublicVlan" class="ui_input_txt03" value="<?php echo ($data["PublicVlan"]); ?>" />
			      </td>
			    </tr>
			    <tr>
